package kx.rnd.com.permissionstest.receiver;
...
import kx.rnd.com.permissionstest.utils.ClsUtils;
...
public class BluetoothReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (BluetoothDevice.ACTION_FOUND.equals(action)) {  //发现设备
            ...
            if (btDevice.getName().contains("H60"))//设备如果有多个，第一个搜到的那个会被尝试。
            {
                Log.e("BondState", "" + btDevice.getBondState());
        ...
        } else if (action.equals("android.bluetooth.device.action.PAIRING_REQUEST")) //再次得到的action，会等于PAIRING_REQUEST
        {
            ...
            if (btDevice.getName().contains("H60")) {
                Log.e("here", "OKOKOK");
