 ...
 * 动态搜索图标
 */
public class PathMesureTest2View extends View {
    ...
    public PathMesureTest2View(Context context) {
        super(context);
        init(null, 0);
    }

    public PathMesureTest2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public PathMesureTest2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initPaint() {
        ...
        mPaint.setStrokeCap(Paint.Cap.ROUND);//设置线帽样式（也就是线段顶部样式，比如：圆、直角等）
